    ...
    <nav class="navbar__container">
        ...
        <ul class="navbar__menu" id="main-menu" role="menu" aria-hidden="true">
            ...
            @if (auth()->check() && auth()->user()->isPlayer())
                <li><a href="{{ route('gameroom.index') }}" class="navbar__link" style="display: flex; gap: 5px; align-items: baseline;">Игровая
                    <span id="notifications-posts" class="notifications-posts" style="display: none;"></span>    
                </a></li>
            @endif

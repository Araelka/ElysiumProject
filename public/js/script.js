...
document.addEventListener('DOMContentLoaded', function () {
    ...
    window.insertMarkdown = function (before, text, after = '', placeholder = '') {
        ...
        // Перемещаем курсор
        markdownInput.focus();
        markdownInput.setSelectionRange(start + before.length, start + before.length + (selectedText || placeholder).length);
